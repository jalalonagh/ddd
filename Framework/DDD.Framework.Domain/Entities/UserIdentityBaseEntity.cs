...
{
    public abstract class UserIdentityBaseEntity<TKey> : IdentityUser<TKey>, IIdentityEntity
        where TKey : System.IEquatable<TKey>
    {
        public UserIdentityBaseEntity()
        {
        }
    ...
    public abstract class UserIdentityBaseEntity : UserIdentityBaseEntity<int>
    {
    }
}
